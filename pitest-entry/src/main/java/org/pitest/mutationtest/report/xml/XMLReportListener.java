...
enum Tag {
  mutation, sourceFile, mutatedClass, mutatedMethod, methodDescription, lineNumber, mutator, indexes, index, killingTest, 
  killingTests, succeedingTests, description, blocks, block, timeoutTests, runErrorTests, memoryErrorTests;
}
